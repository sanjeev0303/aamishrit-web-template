...
//   }
  ...
  return (
    <div className="min-h-dvh bg-[#FDF7F0]">
      {/* Main Content */}
      <main className="container mx-auto px-4 mt-12 pt-2">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-12">
          ...
          <div className="lg:w-[30%] space-y-6 max-h-[600px] overflow-y-auto pr-2 scrollbar-hide">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-bold text-[#6B4226]">{formatPrice(product?.price)}</span>
            ...
            <div>
              <p className="text-[#8B5A2B] line-clamp-3">{product?.description}</p>
            </div>
            ...
            <div>
              <h3 className="font-semibold text-lg text-brown-800 mb-1">Product Details: </h3>
              <span className="text-brown-700 leading-tight ">{product.description}</span>
